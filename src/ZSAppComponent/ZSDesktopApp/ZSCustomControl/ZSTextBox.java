...
public class ZSTextBox extends JTextField{
    public ZSTextBox() {
        customizeComponent();
    }
    ...
    private void customizeComponent() {
        ...
        setCaretColor(ZSAppStyle.COLOR_CURSOR);   // Color del cursor
    ...
    public void setBorderRect() {
        Border lineBorder = BorderFactory.createLineBorder(ZSAppStyle.COLOR_BORDER);
    ...
    private void setBorderDownLine(){
        ...
        setBorder(  BorderFactory.createCompoundBorder(
                    ...
                    BorderFactory.createMatteBorder(0, 0, thickness, 0, ZSAppStyle.COLOR_BORDER) 
        ));
    }
}
